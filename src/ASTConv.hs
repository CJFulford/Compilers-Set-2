...
transProg_stmt x = case x of
  ...
  Prog_stmt3 location -> A.M_read (transLocation location)
  Prog_stmt4 location expr -> A.M_ass (x, y, z) where
...
transInt_factor x = case x of
  ...
  Int_factor4 expr -> A.M_app (A.M_float, (transExpr expr):[])
  ...
  Int_factor7 cid consargumentlist -> A.M_app (A.M_cid (transCID cid), transCons_argument_list consargumentlist)
